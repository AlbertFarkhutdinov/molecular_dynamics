...
class MolecularDynamicsStep(LoggedObject):
    ...
    def __init__(
        ...
        self.immutables = ImmutableParameters(
            particles_number=self.system.particles_number,
    ...
    def fix_current_temperature(self):
        ...
        if self.externals.temperature == 0.0:
            _initial_temperature = self.system.temperature
    ...
    def fix_external_conditions(self):
        ...
        self.fix_current_temperature()
        self.externals.pressure = self.system.pressure
    ...
    def run_md(self):
        ...
        for step in range(1, self.sim_parameters.iterations_numbers + 1):
            ...
            self.logger.info(f'Step: {step}; Time: {self.system.time:.3f};')
            self.md_time_step(
                step=step,
                system_parameters=system_parameters,
