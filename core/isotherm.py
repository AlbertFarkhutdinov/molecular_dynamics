...
from properties import RadialDistributionFunction, TransportProperties


class Isotherm(LoggedObject):
    ...
    def equilibrate(self):
        self.sample.fix_external_conditions()
        self.sample.equilibrate_system(
            equilibration_steps=self.sample.sim_parameters.equilibration_steps,
        )
    ...
    def run(self):
        self.logger.info('********Isothermal calculations started********')
        ...
        # self.ssf.save()
        self.logger.info(
            'Equilibrium dynamics simulation is completed. '
