...
class MTTKNPT(BaseIntegrator):
    ...
    def __init__(self, **integrator_kwargs):
        ...
        self.logger.debug(f'self.thermostats_number = {self.thermostats_number}')
        self.logger.debug(
    ...
    def init_integrator_parameters(self):
        ...
        self.logger.debug(f'self.npt_factor = {self.npt_factor}')
        self.logger.debug(f'self.nvt_factors = {self.nvt_factors}')
        self.logger.debug(f'self.xis = {self.xis}')
        self.logger.debug(f'system_kinetic_energy = {kinetic_energy}')
        self.logger.debug(f'self.g_npt = {self.g_npt}')
        self.logger.debug(f'self.g_nvt = {self.g_nvt}')
    ...
    def get_g_npt(
        ...
        self.logger.debug(f'internal_pressure = {internal_pressure}')
        return (
