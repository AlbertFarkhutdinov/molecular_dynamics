...
from molecular_dynamics.constants import PATH_TO_DATA
from molecular_dynamics.helpers import get_empty_vectors
from molecular_dynamics.log_config import logger_wraps
from molecular_dynamics.numba_procedures import check_distances
from molecular_dynamics.system import Configuration, System
...
class Initializer:
    ...
    def initialize_from_file(self, file_name: str):
        _file_name = PATH_TO_DATA.joinpath(file_name)
