...
from molecular_dynamics.helpers import get_date
from molecular_dynamics.numba_procedures import get_boundary_conditions
from molecular_dynamics.log_config import log_debug_info
...
class System:
    ...
    def save_xyz_file(self, filename: str, step: int):
        _path = PATH_TO_DATA.joinpath(get_date(), filename)
